...
const {isTargetReq, readConfig, recordMockData, decompressData, compressData, streamifyStr, addRoute} = require('./util');
...
module.exports = class Server {
    ...
    updateConfig(route) {
        ...
        if (this.configString.indexOf(JSON.stringify(route)) < 0) {
            ...
            writeConfig(this.configString, configPath);
        }
    }
