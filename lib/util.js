...
module.exports = {
  ...
  convertObjToMod: function convertObjToMod(obj, dir){
    // throw error if config already exists to avoid overwriting
  ...
  updateConfig: function updateConfig(dir, route){
    // this regex only works when routes is in the last
    ...
    fs.readFile(config_dir, 'utf8', function (err, data) {
        ...
        //module.exports.convertObjToMod(JSON.parse(data), config_dir);
    });
  }
}
